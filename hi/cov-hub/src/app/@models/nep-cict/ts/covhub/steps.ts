    ...
    'type_': {
      ...
      'value': {
        ...
        'fields': [
          ...
          {
            'annotations': [],
            'serializedName': 'numberOfB1Forms',
            'default': {
              'kind': 'nothing'
             },
            'name': 'numberOfB1Forms',
            'typeExpr': {
              'typeRef': {
                'kind': 'primitive',
                'value': 'Int16'
          ...
          },
          {
            ...
            'typeExpr': {
              ...
              {
                'annotations': [],
                'serializedName': 'b1FormsInitiated',
                'default': { 'kind': 'nothing' },
                'name': 'b1FormsInitiated',
                'typeExpr': {
                  'typeRef': {
                    'kind': 'primitive',
                     'value': 'Vector'
            ...
            {
              'annotations': [],
              'serializedName': 'yellowUpdateStarted',
               'default': { 'kind': 'nothing' }, 'name': 'yellowUpdateStarted',
               'typeExpr': { 'typeRef': { 'kind': 'primitive',
               'value': 'Bool' }, 'parameters': [] } }, { 'annotations': [], 'serializedName': 'step2Stats',
               'default': { 'kind': 'nothing' }, 'name': 'step2Stats',
               'typeExpr': { 'typeRef': { 'kind': 'reference',
               'value': { 'moduleName': 'covhub.steps',
               'name': 'Step2Stats' } }, 'parameters': [] } }, { 'annotations': [], 'serializedName': 'yellowUpdateFinished',
               'default': { 'kind': 'nothing' }, 'name': 'yellowUpdateFinished',
               'typeExpr': { 'typeRef': { 'kind': 'primitive',
               'value': 'Bool' }, 'parameters': [] } }] } }, 'name': 'Step3',
