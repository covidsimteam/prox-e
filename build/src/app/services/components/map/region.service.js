...
let RegionService = class RegionService {
    ...
    getAndCache(key) {
        return rxjs_1.from(this.spatialService.get(key)).pipe(operators_1.tap((res) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                yield ((_b = (_a = this === null || this === void 0 ? void 0 : this.spatialService) === null || _a === void 0 ? void 0 : _a.instance()) === null || _b === void 0 ? void 0 : _b.get(res['_id']));
            }
            catch (error) {
                res ? delete res['_rev'] : rxjs_1.noop;
                yield ((_c = this.spatialService.instance()) === null || _c === void 0 ? void 0 : _c.put(res));
            }
        })));
    }
