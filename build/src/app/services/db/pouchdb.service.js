    ...
    */
    ...
    remoteLogin(dbName) {
        ...
        if (!((_a = this === null || this === void 0 ? void 0 : this.authService) === null || _a === void 0 ? void 0 : _a.isAuthenticated))
            return this.getRemoteDBInstance(dbName);
        rxjs_1.from(remoteDB.logIn((_b = this.authService) === null || _b === void 0 ? void 0 : _b.user, (_c = this.authService) === null || _c === void 0 ? void 0 : _c.pass)).subscribe(_ => {
    ...
    remoteSync(dbName) {
        ...
        rxjs_1.from(remoteDB.logIn((_a = this.authService) === null || _a === void 0 ? void 0 : _a.user, (_b = this.authService) === null || _b === void 0 ? void 0 : _b.pass))
            .subscribe(_ => {
            this.databases[dbName].remoteInstance = remoteDB;
            localDB === null || localDB === void 0 ? void 0 : localDB.sync(remoteDB, { live: true }).on('change', emitOnChange).on('complete', emitOnChange).on('error', (err) => this.logger.error(err));
