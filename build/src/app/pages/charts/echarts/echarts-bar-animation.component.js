    ...
    ngAfterViewInit() {
        this.themeSubscription = this.theme.getJsTheme().subscribe((config) => {
            ...
            this.options = {
                ...
                color: [colors === null || colors === void 0 ? void 0 : colors.primaryLight, colors === null || colors === void 0 ? void 0 : colors.infoLight],
                legend: {
                    data: ['bar', 'bar2'],
                    align: 'left',
                    textStyle: {
                        color: echarts === null || echarts === void 0 ? void 0 : echarts.textColor,
                    },
                },
                xAxis: [
                    {
                        ...
                        axisLine: {
                            lineStyle: {
                                color: echarts === null || echarts === void 0 ? void 0 : echarts.axisLineColor,
                            },
                        },
                        axisLabel: {
                            textStyle: {
