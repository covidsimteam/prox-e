...
let ECommerceVisitorsStatisticsComponent = class ECommerceVisitorsStatisticsComponent {
    ...
    ngAfterViewInit() {
        this.theme.getJsTheme()
            ...
            .subscribe(config => {
            var _a;
            const variables = config === null || config === void 0 ? void 0 : config.variables;
            const visitorsPieLegend = (_a = config === null || config === void 0 ? void 0 : config.variables) === null || _a === void 0 ? void 0 : _a.visitorsPieLegend;
