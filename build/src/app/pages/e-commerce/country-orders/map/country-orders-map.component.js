...
let CountryOrdersMapComponent = class CountryOrdersMapComponent {
    ...
    findFeatureLayerByCountryId(id) {
        const layers = this.layers[0];
        const featureLayer = layers === null || layers === void 0 ? void 0 : layers.getLayers().find((item) => {
            var _a;
            return ((_a = item === null || item === void 0 ? void 0 : item.feature) === null || _a === void 0 ? void 0 : _a.id) === id;
        });
